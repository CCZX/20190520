webpackJsonp([1], [, , , , , , , , , , , function (t, e, a) {
  ...
  function r () {
    ...
    t.className = 'lip', document.body.appendChild(t), setTimeout(function () {
      t.remove()
    }, 2500)
  }
  ...
  function i (t, e) {
    ...
    a.style.display = 'block', setTimeout(function () {
      a.style.right = t && t !== 'hide' ? '0' : 'calc(-100vw - 10px)'
  ...
  function o () {
    ...
    document.querySelector('#send').addEventListener('click', function () {
      p()
    }), t.className = 'show', e.style.display = 'block', a.style.display = 'block', setTimeout(function () {
      l()
    }, 2e3)
  }
  ...
  function l () {
    ...
    document.querySelector('#timer').style.display = 'block', new m.default('count', 0, n, 0, 5).start()
  }

  function p () {
    var t = document.querySelector('#send')
    t.setAttribute('disabled', ''), setTimeout(function () {
    ...
    for (var a = 0; a < 30; a++) {
      ...
      n.setAttribute('src', f), n.setAttribute('class', 'stars'), e.appendChild(n)
    }
    ...
    o.className = 'comment', o.style.bottom = 80 + 55 * r + 'px', o.innerHTML = '520快乐呀！', document.body.appendChild(o), document.body.appendChild(e)
  ...
  g.setAttribute('src', f), b.setAttribute('src', h), e.go = s
}, , function (t, e, a) {
    ...
    !(function (r, i) {
      n = i, void 0 !== (s = typeof n === 'function' ? n.call(e, a, e, t) : n) && (t.exports = s)
    }(0, function () {
      function t (e, a) {
        if (!(this instanceof t)) return new n(e, a)
        if (typeof e === 'string' && (e = document.querySelector(e)), e && e[0] && e[0].nodeName && (e = e[0]), !e) throw new Error('Unknown element')
        this.el = e, this.stack = [], this.last = null, this._speed = 50 + Math.round(30 * Math.random()), this.length = 0, this.iterations = 0, this.classNames = {
      ...
      var n = t
      return t.defaultSpeed = 50, t.prototype.type = function (t, n, s) {
        typeof n === 'number' && (s = n, n = void 0)
        var r, i = this
        r = s === 0 ? [t] : t.split('')
        for (var o = 0, l = r.length; o < l; o++) {
          ...
          !(function (t, r) {
            i.queue(function (o) {
              r === 0 && (a(i.el, i.classNames.typing), i.spanSync(n)), i.typeSync(t), r === l - 1 && e(i.el, i.classNames.typing), i.defer(o, s)
            })
          }(p, o))
        }
        return this
        ...
        return this.queue(function (n) {
          a(this.el, this.classNames.waiting), this.defer(function () {
            e(this.el, this.classNames.waiting), n()
          }, t)
        })
      }, t.prototype.clear = function (t) {
        var e = this
        return t === 0 ? this.queue(function (t) {
          this.clearAllSync(), t()
        }) : this.queue(function (a) {
          function n () {
            if (e.length === 0) return a()
            e.delSync(), e.defer(n, t)
          }
          n()
        })
        ...
        function e () {
          n.shift(), n.length && (n[0].call(a, e), a.iterations++)
        }
        var a = this,
          n = this.stack
        return n.push(t), n.length === 1 && (this.iterations++, t.call(a, e)), this
      }, t.prototype.defer = function (t, e) {
        if (e === 0) return t.call(this), this
        typeof e === 'number' ? e *= this._speed : e = Math.floor(101 * Math.random()) + 50
        var a = this
        ...
        if (t && t.substr(0, 1) === '<') {
          ...
          a.innerHTML = t, e = a.children[0], e || (e = document.createElement('span'))
        } else e = document.createElement('span'), t && (e.className = t.replace(/\./, ' '))
        return this.el.appendChild(e), this.last = e, this
      }, t.prototype.typeSync = function (t, e) {
        return e ? this.spanSync(e) : this.last || this.spanSync(), this.length += t.length, t = t.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\n/g, '<br>'), this.last.innerHTML += t, this
      }, t.prototype.delSync = function () {
        if (!this.last) return this
        this.length--
        var t = this.last.innerHTML
        return t.length === 1 ? this.popSpanSync() : (this.last.innerHTML = t.substr(t, t.length - 1), t.length === 0 ? this.popSpanSync() : this)
      ...
      return function (t, e, a, n, s, r) {
        function i (t) {
          ...
          if (t = Math.abs(t).toFixed(p.decimals), t += '', e = t.split('.'), a = e[0], n = e.length > 1 ? p.options.decimal + e[1] : '', p.options.useGrouping) {
            for (s = '', r = 0, i = a.length; r < i; ++r) r !== 0 && r % 3 == 0 && (s = p.options.separator + s), s = a[i - r - 1] + s
            a = s
          }
          return p.options.numerals.length && (a = a.replace(/[0-9]/g, function (t) {
        ...
        if (p.version = function () {
          ...
          suffix: '',
          numerals: []
        }, r && typeof r === 'object') { for (var c in p.options) r.hasOwnProperty(c) && r[c] !== null && (p.options[c] = r[c]) }
        p.options.separator === '' ? p.options.useGrouping = !1 : p.options.separator = '' + p.options.separator
        for (var y = 0, u = ['webkit', 'moz', 'ms', 'o'], m = 0; m < u.length && !window.requestAnimationFrame; ++m) window.requestAnimationFrame = window[u[m] + 'RequestAnimationFrame'], window.cancelAnimationFrame = window[u[m] + 'CancelAnimationFrame'] || window[u[m] + 'CancelRequestAnimationFrame']
        window.requestAnimationFrame || (window.requestAnimationFrame = function (t, e) {
          ...
          p.startTime || (p.startTime = t), p.timestamp = t
          var e = t - p.startTime
          ...
          if (p.initialize()) {
            ...
            p.error = '', t !== p.frameVal && (cancelAnimationFrame(p.rAF), p.paused = !1, delete p.startTime, p.startVal = p.frameVal, p.endVal = t, p.countDown = p.startVal > p.endVal, p.rAF = requestAnimationFrame(p.count))
          }
    ...
    e = t.exports = a(0)(!1), e.push([t.i, '.purple{color:#c66cdc}.blue{color:#61a2c0}.gray{color:#bbbba1}.red{color:#c34034}.green{color:#98c379}.green-blue{color:#56b6c2}.yellow{color:#d9963f}.heartBg{background-color:#fc2e5a}.note{color:#5c6370;font-size:.12rem}.blank,.note{margin:0}', ''])
  }, function (t, e, a) {
    var n = a(19)
    typeof n === 'string' && (n = [
      [t.i, n, '']
